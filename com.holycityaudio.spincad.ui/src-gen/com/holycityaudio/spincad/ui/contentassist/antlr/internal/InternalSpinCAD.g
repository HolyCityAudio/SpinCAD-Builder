...
{ after(grammarAccess.getControlAccess().getLogFreqSliderLabelParserRuleCall_2()); }
    ...
    |(
{ before(grammarAccess.getControlAccess().getSpinRadioButtonParserRuleCall_3()); }
	ruleSpinRadioButton
{ after(grammarAccess.getControlAccess().getSpinRadioButtonParserRuleCall_3()); }
)

    |(
{ before(grammarAccess.getControlAccess().getSliderLabelCheckBoxParserRuleCall_4()); }
	ruleSliderLabelCheckBox
{ after(grammarAccess.getControlAccess().getSliderLabelCheckBoxParserRuleCall_4()); }
)
...
{ after(grammarAccess.getMacroAccess().getIsEqualToParserRuleCall_5()); }
    ...
    |(
{ before(grammarAccess.getMacroAccess().getIsLessThanParserRuleCall_6()); }
	ruleIsLessThan
{ after(grammarAccess.getMacroAccess().getIsLessThanParserRuleCall_6()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getGetInputDefaultParserRuleCall_7()); }
	ruleGetInputDefault
{ after(grammarAccess.getMacroAccess().getGetInputDefaultParserRuleCall_7()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getGetDelayScaleControlParserRuleCall_8()); }
	ruleGetDelayScaleControl
{ after(grammarAccess.getMacroAccess().getGetDelayScaleControlParserRuleCall_8()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getSetOutputPinParserRuleCall_9()); }
	ruleSetOutputPin
{ after(grammarAccess.getMacroAccess().getSetOutputPinParserRuleCall_9()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getGetBaseAddressParserRuleCall_10()); }
	ruleGetBaseAddress
{ after(grammarAccess.getMacroAccess().getGetBaseAddressParserRuleCall_10()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getGetSamplesFromRatioParserRuleCall_11()); }
	ruleGetSamplesFromRatio
{ after(grammarAccess.getMacroAccess().getGetSamplesFromRatioParserRuleCall_11()); }
)

    |(
{ before(grammarAccess.getMacroAccess().getMinusDoubleParserRuleCall_12()); }
	ruleMinusDouble
{ after(grammarAccess.getMacroAccess().getMinusDoubleParserRuleCall_12()); }
)
...
:
(
{ before(grammarAccess.getSliderLabelCheckBoxAccess().getControlNameIDTerminalRuleCall_2_0()); }
	RULE_ID{ after(grammarAccess.getSliderLabelCheckBoxAccess().getControlNameIDTerminalRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getLogFreqSliderLabelAccess().getControlNameIDTerminalRuleCall_2_0()); }
	RULE_ID{ after(grammarAccess.getLogFreqSliderLabelAccess().getControlNameIDTerminalRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getSpinRadioButtonAccess().getControlNameIDTerminalRuleCall_2_0()); }
	RULE_ID{ after(grammarAccess.getSpinRadioButtonAccess().getControlNameIDTerminalRuleCall_2_0()); }
)
