		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEquateAccess().getGroup_3_2(), "rule__Equate__Group_3_2__0");
					...
					put(grammarAccess.getBoolAccess().getGroup_3(), "rule__Bool__Group_3__0");
					...
					put(grammarAccess.getEquateAccess().getMinValAssignment_3_2_0(), "rule__Equate__MinValAssignment_3_2_0");
					put(grammarAccess.getEquateAccess().getMaxValAssignment_3_2_1(), "rule__Equate__MaxValAssignment_3_2_1");
					put(grammarAccess.getEquateAccess().getMultiplierAssignment_3_2_2(), "rule__Equate__MultiplierAssignment_3_2_2");
					put(grammarAccess.getEquateAccess().getPrecisionAssignment_3_2_3(), "rule__Equate__PrecisionAssignment_3_2_3");
					put(grammarAccess.getEquateAccess().getOptionAssignment_3_2_4(), "rule__Equate__OptionAssignment_3_2_4");
					...
					put(grammarAccess.getBoolAccess().getEnameAssignment_1(), "rule__Bool__EnameAssignment_1");
					put(grammarAccess.getBoolAccess().getValueAssignment_2(), "rule__Bool__ValueAssignment_2");
					put(grammarAccess.getBoolAccess().getControlTypeAssignment_3_0(), "rule__Bool__ControlTypeAssignment_3_0");
					put(grammarAccess.getBoolAccess().getControlNameAssignment_3_1(), "rule__Bool__ControlNameAssignment_3_1");
					...
					put(grammarAccess.getIsTrueAccess().getArg1Assignment_1(), "rule__IsTrue__Arg1Assignment_1");
