...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Equate</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 *
 * @see com.holycityaudio.spincad.spinCAD.SpinCADPackage#getEquate()
 * @model
 * @generated
 */
public interface Equate extends SpinElement
{
  /**
   ...
   * @see #setEname(String)
   * @see com.holycityaudio.spincad.spinCAD.SpinCADPackage#getEquate_Ename()
   * @model
   * @generated
   */
  String getEname();
  ...
  /**
   * Sets the value of the '{@link com.holycityaudio.spincad.spinCAD.Equate#getEname <em>Ename</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see com.holycityaudio.spincad.spinCAD.SpinCADPackage#getEquate_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link com.holycityaudio.spincad.spinCAD.Equate#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
